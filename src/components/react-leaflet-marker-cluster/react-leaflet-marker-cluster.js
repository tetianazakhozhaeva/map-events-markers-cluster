...
export default class MarkerClusterGroup extends LayerGroup {
  componentWillMount() {
    ...
    if (options) {
      console.warn(
        '[react-leaflet-markercluster] Warning: "options" property is deprecated' +
    ...
    if (markers.length) {
      ...
      if (havingDeprecatedProps(markers)) {
        console.warn(
          '[react-leaflet-markercluster] Warning: marker "lat: xx", "lng: xx" properties are deprecated' +
  ...
  initMapClasses() {
    ...
    if (wrapperOptions) {
      console.warn(
        '[react-leaflet-markercluster] Warning: "wrapperOptions" property is deprecated' +
  ...
  addLayersWithMarkersFromProps(markers) {
    ...
    const filteredMarkers =
      wrapperOptions && wrapperOptions.removeDuplicates
